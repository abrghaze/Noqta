...
@section('breadcrumb', 'Créer un Utilisateur')
...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">Ajouter un étudiant, enseignant, parent ou directeur</p>
            </div>
    ...
    <div class="rounded-xl bg-white shadow-sm">
        <form method="POST" action="{{ route('directeur.users.store') }}" id="createUserForm">
            @csrf
            ...
            <div class="p-6 space-y-6">
                ...
                <div id="teacherFields" class="hidden space-y-6">
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mb-2">Vous pourrez assigner des matières après la création du compte</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="parentFields" class="hidden space-y-6">
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div class="mt-4">
                            <p class="text-sm text-gray-500">Vous pourrez lier des enfants après la création du compte</p>
                        </div>
                    </div>
                </div>
            </div>
