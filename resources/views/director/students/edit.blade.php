...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0"><i class="fas fa-edit"></i> Modifier l'Étudiant: {{ $student->user->name }}</h1>
        <a href="{{ route('directeur.students.index') }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left"></i> Retour
        </a>
    </div>

    <form action="{{ route('directeur.students.update', $student->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="matricule" class="form-label">Numéro d'étudiant</label>
                                <input type="text" class="form-control" id="matricule" 
                                       value="{{ $student->matricule }}" readonly disabled>
                    ...
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <img id="profilePreview" 
                                 src="{{ $student->user->profile_picture ? asset('storage/' . $student->user->profile_picture) : 'https://via.placeholder.com/200x200?text=Photo' }}" 
                                 alt="Profile Preview" 
